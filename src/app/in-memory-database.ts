...
export class InMemoryDatabase implements InMemoryDbService {
  ...
  createDb() {
    ...
    const entries: Entry[] = [
      ...
      { id: 5, name: 'Basis', categoryId: categories[3].id, category: categories[3], paid: true, date: '20/10/2019', amount: '1700,00', type: 'revenue',  description: '' } as Entry,
      { id: 6, name: 'Funcab', categoryId: categories[4].id, category: categories[4], paid: true, date: '20/10/2019', amount: '800,00', type: 'revenue',  description: '' } as Entry,
